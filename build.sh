...
DEVICE_DIR=${BUILD_DIR}/Build/Products/Release-iphoneos/${FMK_NAME}/${FMK_NAME}.framework
SIMULATOR_DIR=${BUILD_DIR}/Build/Products/Release-iphonesimulator/${FMK_NAME}/${FMK_NAME}.framework
